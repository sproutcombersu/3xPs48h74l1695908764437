...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Supermoney88 Slot Demo";
        private static string COMPANY_NAME = "1695909471529645792981";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.supermoneydelapandelapanslot.supermoney";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "tomkey";
        private static string KEY_ALIAS_NAME = "tomkey";
        private static string KEY_ALIAS_PASS = "tomkey";
